...
abstract class BaseResidentsFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'redirect_active'         => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
      'redirect_to'             => new sfWidgetFormFilterInput(),
      'redirect_seconds'        => new sfWidgetFormFilterInput(),
      'account_number'          => new sfWidgetFormFilterInput(),
      'bank_number'             => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'redirect_active'         => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
      'redirect_to'             => new sfValidatorPass(array('required' => false)),
      'redirect_seconds'        => new sfValidatorPass(array('required' => false)),
      'account_number'          => new sfValidatorPass(array('required' => false)),
      'bank_number'             => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
