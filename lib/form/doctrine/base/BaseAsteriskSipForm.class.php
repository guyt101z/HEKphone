...
/**
 * AsteriskSip form base class.
 *
 * @method AsteriskSip getObject() Returns the current form's model object
 *
 * @package    hekphone
 * @subpackage form
 ...
 */
abstract class BaseAsteriskSipForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'regexten'    => new sfWidgetFormInputText(),
      'regserver'   => new sfWidgetFormInputText(),
      'regseconds'  => new sfWidgetFormInputText(),
      'fromuser'    => new sfWidgetFormInputText(),
      'fromdomain'  => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'context'     => new sfValidatorString(array('max_length' => 20, 'required' => false)),
      ...
      'regexten'    => new sfValidatorString(array('max_length' => 20, 'required' => false)),
      ...
      'fromuser'    => new sfValidatorString(array('max_length' => 20, 'required' => false)),
      'fromdomain'  => new sfValidatorString(array('max_length' => 20, 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('asterisk_sip[%s]');
