 ...
 * @method enum                getTechnologie() Returns the current record's "technologie" value
 ...
 * @method Phones              setTechnologie() Sets the current record's "technologie" value
...
abstract class BasePhones extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('technologie', 'enum', 20, array(
             'type' => 'enum',
             'length' => 20,
             'values' => 
             array(
